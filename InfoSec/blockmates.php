...
//fetch blockmates posts from posts table
$query = "SELECT * FROM tblComments WHERE category_id=2 ORDER BY date_time DESC";
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto my-3 my-lg-0">
						...
						<li class="nav-item"><a class="nav-link active" href="blockmates.php">Blockmates</a></li>
