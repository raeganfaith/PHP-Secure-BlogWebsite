...
$query = "SELECT * FROM tblComments WHERE category_id=2";
...
?>
		...
		<ul class="sidebar-nav list-unstyled" id="sidebar-nav">
			...
			<div class="collapse" id="postmanagement">
				<ul class="text-white list-unstyled">
					...
					<a href="manage-blockmates.php" class="sidenav-link active"><li class="sidenav-item text-white active ps-5"><i class="bi bi-people me-3"></i>Blockmates</li></a>
	...
	<main>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<h4 class="card-header fw-bold sticky-top" id="card-header">Blockmates</h4>
							...
							<tbody class="align-middle">
								<?php foreach($posts as $post) : ?>
									...
									function deleteme(delid){
										...
										.then((willDelete) => {
										  if (willDelete) {
											window.location.href = 'delete-post-blockmates.php?del_id=' +delid+'';
										  }
										});
									}
								</script>
