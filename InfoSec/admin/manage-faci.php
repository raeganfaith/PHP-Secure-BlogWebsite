...
$query = "SELECT * FROM tblComments WHERE category_id=4";
...
?>
		...
		<ul class="sidebar-nav list-unstyled" id="sidebar-nav">
			...
			<div class="collapse" id="postmanagement">
				<ul class="text-white list-unstyled">
					...
					<a href="manage-faci.php" class="sidenav-link active"><li class="sidenav-item text-white active ps-5"><i class="bi bi-building me-3"></i>Facilities</li></a>
				</ul>
			</div>
	...
	<main>
		...
		<div class="row">
			<div class="col-12">
				<div class="card">
					<h4 class="card-header fw-bold sticky-top text" id="card-header">Facilities</h4>
							...
							<tbody class="align-middle">
								<?php foreach($posts as $post) : ?>
									...
									function deleteme(delid){
										...
										.then((willDelete) => {
										  if (willDelete) {
											window.location.href = 'delete-post-faci.php?del_id=' +delid+'';
										  }
										});
									}
								</script>
