...
//fetch acads posts from posts table
$query = "SELECT * FROM tblComments WHERE category_id=1 ORDER BY date_time DESC";
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto my-3 my-lg-0">
						...
						<li class="nav-item"><a class="nav-link active" href="acads.php">Academics</a></li>
				...
				<div class="comments">
					<?php while ($post = mysqli_fetch_assoc($posts)) : ?>
						<div class="card" id="card">
							<h5 class="card-header fw-bold sticky-top sticky-top"><?= $post['id'] ?></h5>
